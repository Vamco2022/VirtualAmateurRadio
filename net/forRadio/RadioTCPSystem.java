...
public class RadioTCPSystem {
    ...
    public void start(){
        printLog.printlnWithColorTag("RTS:INFO","RTS is working now, open port on IN " + inputPort + ", OUT " + outputPort,COLOR.GREEN);
        while (true){
            try {
                ...
                printLog.printlnWithColorTag("RTS:WARNING", "The port is using now!", COLOR.YELLOW);
                printLog.printlnWithColor("System was failed because the port in RTS is using by other programs", COLOR.RED);
